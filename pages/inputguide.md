...
**Caution:**{: style="color: red"} Sometimes it is necessary to override this default: If the band CG (of the occupied states) is far removed the natural CG of the particular channel, you must restrict how far P can be shifted to the band CG. In some cases, allowing P to float completely will result in “ghost bands”.
